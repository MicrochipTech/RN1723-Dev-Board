...
#elif defined(MICROCHIP_RN1723)
    #include <time.h>
    #define XTIME(t1) rn171_time((t1))
...
#if defined (MICROCHIP_RN1723)
time_t GetRNTime(void)
{
    time_t sec = 1432238104;
...
time_t rn171_time(time_t* timer)
{
//    struct tm  t;
//    time_t timeNow;
//
...
//    return timeNow;
    time_t timeNow;
    timeNow = (time_t) PIC32_Time();
    return timeNow;
}
        
#endif /* MICROCHIP_RN1723 */
